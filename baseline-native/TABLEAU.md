...
| `checkSUB1` | single | TEXTE | 0 | 2 | 1 | — |
| `checkVolMasterSlave` | single | MIDI | 6 | 12 | 1 | 1 |
| `csound` | single | MIDI | 8 | 11 | 1 | 2 |
...
| `koto1` | single | TEXTE | 0 | 7 | 1 | — |
| `koto2` | single | TEXTE | 0 | 7 | 1 | — |
...
| `shapes-rhythm` | single | MIDI | 1952 | 4685 | 1 | — |
