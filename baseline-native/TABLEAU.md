...
|---|---|---|---|---|---|---|
| `765432` | `-gr.765432` | MIDI | oui | 823 | 1405 | captures/765432.tokens.json |
| `Djinns` | `-gr.Djinns` | MIDI | oui | 895 | 851 | captures/Djinns.tokens.json |
| `Mozartexpression` | `-gr.Mozartexpression` | MIDI | oui | 251 | 27 | captures/Mozartexpression.tokens.json |
| `MyMelody` | `-gr.MyMelody` | MIDI | oui | 31 | 31 | captures/MyMelody.tokens.json |
| `Nadaka-1er-essai` | `-gr.Nadaka-1er-essai` | MIDI | oui | 4 | 4 | captures/Nadaka-1er-essai.tokens.json |
| `PP` | `-gr.PP` | MIDI | oui | 26 | 73 | captures/PP.tokens.json |
| `acceleration` | `-gr.acceleration` | MIDI | oui | 78 | 100 | captures/acceleration.tokens.json |
| `acceleration_v2` | `-gr.acceleration` | MIDI | oui | 78 | 100 | captures/acceleration_v2.tokens.json |
| `alan-dice` | `-gr.Alan` | MIDI | oui | 5069 | 3421 | captures/alan-dice.tokens.json |
| `ames` | `-gr.Ames` | MIDI | oui | 11 | 7 | captures/ames.tokens.json |
| `beatrix-dice` | `-gr.Beatrix` | MIDI | oui | 5069 | 3381 | captures/beatrix-dice.tokens.json |
| `bells` | `-gr.bells` | MIDI | oui | 16 | 17 | captures/bells.tokens.json |
| `check&` | `-gr.check&` | MIDI | oui | 4 | 6 | captures/check_.tokens.json |
| `checkSUB` | `-gr.checkSUB` | MIDI | oui | 10 | 13 | captures/checkSUB.tokens.json |
...
| `koto3` | `-gr.koto3` | MIDI | oui | 22 | 266 | captures/koto3.tokens.json |
| `kss2` | `-gr.kss2` | MIDI | oui | 97 | 138 | captures/kss2.tokens.json |
| `livecode1` | `-gr.livecode1` | MIDI | oui | 540 | 460 | captures/livecode1.tokens.json |
| `livecode2` | `-gr.livecode2` | MIDI | oui | 580 | 427369900 | captures/livecode2.tokens.json |
| `major-minor` | `-gr.tryMajorMinor` | MIDI | oui | 24 | 2 | captures/major-minor.tokens.json |
| `mohanam` | `-gr.trial.mohanam` | MIDI | oui | 755 | 1173 | captures/mohanam.tokens.json |
| `mozart-dice` | `-gr.Mozart` | MIDI | oui | 10113 | 6416 | captures/mozart-dice.tokens.json |
| `nadaka` | `-gr.Nadaka` | MIDI | oui | 714 | 1007 | captures/nadaka.tokens.json |
| `negative-context` | `-gr.checkNegativeContext` | MIDI | oui | 6 | 6 | captures/negative-context.tokens.json |
| `not-reich` | `-gr.NotReich` | MIDI | oui | 580 | 565 | captures/not-reich.tokens.json |
...
| `transposition3` | `-gr.transposition3` | MIDI | oui | 66 | 30 | captures/transposition3.tokens.json |
| `tryKeyMap` | `-gr.tryKeyMap` | MIDI | oui | 392 | 450 | captures/tryKeyMap.tokens.json |
| `tryKeyXpand` | `-gr.tryKeyXpand` | MIDI | oui | 91 | 120 | captures/tryKeyXpand.tokens.json |
...
| `tunings` | `-gr.tryTunings` | MIDI | oui | 16 | 16 | captures/tunings.tokens.json |
| `visser-shapes` | `-gr.Visser.Shapes` | MIDI | oui | 2086 | 2553 | captures/visser-shapes.tokens.json |
| `visser-waves` | `-gr.Visser.Waves` | MIDI | oui | 365 | 433 | captures/visser-waves.tokens.json |
| `visser3` | `-gr.Visser3` | MIDI | oui | 401 | 770 | captures/visser3.tokens.json |
| `visser5` | `-gr.Visser5` | MIDI | oui | 1152 | 1822 | captures/visser5.tokens.json |
| `watch` | `-gr.Watch_What_Happens` | MIDI | oui | 2105 | 5122 | captures/watch.tokens.json |
| `Alarm` | `-gr.Alarm` | TEXTE | oui |  | 26 | captures/Alarm.text.txt |
| `all-items` | `-gr.tryAllItems` | TEXTE | oui |  | 36 | captures/all-items.text.txt |
| `all-items1` | `-gr.tryAllItems1` | TEXTE | oui |  | 36 | captures/all-items1.text.txt |
| `asymmetric` | `-gr.asymmetric1` | TEXTE | oui |  | 318 | captures/asymmetric.text.txt |
| `checkBT` | `-gr.checkBT` | TEXTE | oui |  | 80 | captures/checkBT.text.txt |
| `checkSUB1` | `-gr.checkSUB1` | TEXTE | oui |  | 2 | captures/checkSUB1.text.txt |
| `destru` | `-gr.tryDESTRU` | TEXTE | oui |  | 44 | captures/destru.text.txt |
