...
- **D1** `ouvert` —
  **POINT DE REPRISE (2026-08-14)** : rien n'est engagé de mon côté et rien ne l'a jamais été — l'item
  ...
  GARDE-CHEMINS-SORTANTS: absence — le cahier des charges cité ci-dessous a été RETIRÉ du hub par
  `3a5f11ec` et n'a aucun successeur ; son nom reste écrit parce qu'il désigne la source du besoin.
