...
- **BPE-6/BPE-7** `fait` [P1] — REGLAGES-ANCIEN-FORMAT-NON-LUS.
  ...
  **CE QUI REND LA CONVERSION SURE CETTE FOIS** : `scripts/convertir-reglages-bp2.py` porte le
  ...
  GARDE-CHEMINS-SORTANTS: absence — BPscript/test/s0_snapshot.cjs retiré avec le pipeline S0-S5 ; cf. BPE-1 `sans-objet`.
  ...
  GARDE-CHEMINS-SORTANTS: absence — BPscript/test/s0_snapshot.cjs retiré, même cause que ci-dessus.
