 ...
 *  Prevents -BP2.h from pulling in ALSA or Windows headers.
 */

#ifndef BP3_WASM_PLATFORM_H
#define BP3_WASM_PLATFORM_H

/* Emscripten defines __linux__ by default, which causes -BP2.h to
   #include <alsa/asoundlib.h>. We undefine platform macros so that
   the platform-specific blocks in -BP2.h are skipped entirely. */
#ifdef __linux__
#undef __linux__
#endif
...
/* Provide the platform-specific types that -BP2.h defines inside
